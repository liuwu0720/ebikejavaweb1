...
public class DdcHyxhBasbLog implements java.io.Serializable {
	...
	@SequenceGenerator(name = "DDC_HYXH_BASB_LOG", sequenceName = "SEQ_DDC_HYXH_BASB_LOG", allocationSize = 1)
	@Id
	@GeneratedValue(strategy = SEQUENCE, generator = "DDC_HYXH_BASB_LOG")
