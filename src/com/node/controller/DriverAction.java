...
public class DriverAction {
	...
	public Map<String, Object> queryAll(HttpServletRequest request,
			...
			Integer userStatus, String hyxhzh, String dwmcId) {
		...
		Map<String, Object> resultMap = iDriverService.queryBySpringsql(sql,
				page);
		return resultMap;
	}
	...
	public String queryInfoById(HttpServletRequest request, String id) {
		...
		DdcHyxhBase ddcHyxhBase = iInDustryService
				.getDdcHyxhBaseByCode(ddcDriver.getHyxhzh());
		DdcHyxhSsdw ddcHyxhSsdw = iInDustryService.getDdcHyxhSsdwById(ddcDriver
				.getSsdwId());
	...
	public void deleteRow(String id, HttpServletRequest request,
		...
		try {
			iDriverService.deleteById(driverId);
