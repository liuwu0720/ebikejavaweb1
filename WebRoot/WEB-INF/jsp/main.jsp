...
<frameset rows ="112px,*">
    ...
    <frameset id="frameset" cols="230px,*" >
        <frame noresize="noresize" frameborder="0" scrolling="auto"  border="0" border-color="#fff000"  id="sidebar" name="sidebar" src="<%=basePath%>mainAction/getSidebar">
        <frame noresize="noresize" frameborder="0" scrolling="auto" border="0" border-color="#fff000" id="main" name="main" src="<%=basePath%>mainAction/getWelcome">
    </frameset>
